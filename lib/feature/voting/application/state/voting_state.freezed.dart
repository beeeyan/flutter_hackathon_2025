...
/// 残り時間（秒）
 ...
 bool get isTimeUp;/// 送信待ちキュー {targetUid: count}
 Map<String, int> get sendQueue;/// 最後にキューをフラッシュした時間
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is VotingState&&(identical(other.remainingSeconds, remainingSeconds) || other.remainingSeconds == remainingSeconds)&&(identical(other.remainingPoints, remainingPoints) || other.remainingPoints == remainingPoints)&&(identical(other.isTimeUp, isTimeUp) || other.isTimeUp == isTimeUp)&&const DeepCollectionEquality().equals(other.sendQueue, sendQueue)&&(identical(other.lastFlushTime, lastFlushTime) || other.lastFlushTime == lastFlushTime));
}


@override
int get hashCode => Object.hash(runtimeType,remainingSeconds,remainingPoints,isTimeUp,const DeepCollectionEquality().hash(sendQueue),lastFlushTime);

@override
String toString() {
  return 'VotingState(remainingSeconds: $remainingSeconds, remainingPoints: $remainingPoints, isTimeUp: $isTimeUp, sendQueue: $sendQueue, lastFlushTime: $lastFlushTime)';
}
...
@useResult
$Res call({
 int remainingSeconds, int remainingPoints, bool isTimeUp, Map<String, int> sendQueue, DateTime? lastFlushTime
});
...
/// Create a copy of VotingState
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? remainingSeconds = null,Object? remainingPoints = null,Object? isTimeUp = null,Object? sendQueue = null,Object? lastFlushTime = freezed,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( int remainingSeconds,  int remainingPoints,  bool isTimeUp,  Map<String, int> sendQueue,  DateTime? lastFlushTime)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _VotingState() when $default != null:
return $default(_that.remainingSeconds,_that.remainingPoints,_that.isTimeUp,_that.sendQueue,_that.lastFlushTime);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( int remainingSeconds,  int remainingPoints,  bool isTimeUp,  Map<String, int> sendQueue,  DateTime? lastFlushTime)  $default,) {final _that = this;
switch (_that) {
case _VotingState():
return $default(_that.remainingSeconds,_that.remainingPoints,_that.isTimeUp,_that.sendQueue,_that.lastFlushTime);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( int remainingSeconds,  int remainingPoints,  bool isTimeUp,  Map<String, int> sendQueue,  DateTime? lastFlushTime)?  $default,) {final _that = this;
switch (_that) {
case _VotingState() when $default != null:
return $default(_that.remainingSeconds,_that.remainingPoints,_that.isTimeUp,_that.sendQueue,_that.lastFlushTime);case _:
  return null;
...
class _VotingState implements VotingState {
  const _VotingState({this.remainingSeconds = 60, this.remainingPoints = 100, this.isTimeUp = false, final  Map<String, int> sendQueue = const {}, this.lastFlushTime}): _sendQueue = sendQueue;
...
@override
int get hashCode => Object.hash(runtimeType,remainingSeconds,remainingPoints,isTimeUp,const DeepCollectionEquality().hash(_sendQueue),lastFlushTime);
...
/// Create a copy of VotingState
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? remainingSeconds = null,Object? remainingPoints = null,Object? isTimeUp = null,Object? sendQueue = null,Object? lastFlushTime = freezed,}) {
